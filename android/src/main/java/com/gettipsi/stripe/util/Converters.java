...
//        result.putString("cvc", card.getCvc());
    ...
    public static ArrayList<CountrySpecification> getAllowedShippingCountries(
    ...
    public static CardParams createCard(final ReadableMap cardData) {
        return new CardParams(
                ...
                new Address(
                        cardData.getString("addressCity"),
                        cardData.getString("addressCountry"),
                        cardData.getString("addressLine1"),
                        cardData.getString("addressLine2"),
                        cardData.getString("addressZip"),
                        cardData.getString("addressState")
                ),
                cardData.getString("currency")
        );
    }
    ...
    public static WritableMap convertSourceToWritableMap(@Nullable Source source) {
        ...
        // after 17.x.y Metadata is no longer returned to clients using publishable keys. Retrieve them on your server using your secret key instead.
...
//    }
    ...
    public static WritableMap convertPaymentMethodToWritableMap(
        ...
        wm.putMap("billingDetails",
                convertBillingDetailsToWritableMap(paymentMethod.billingDetails));
    ...
    @NonNull
    public static WritableMap convertReceiverToWritableMap(
            @Nullable final Source.Receiver receiver) {
        WritableMap map = Arguments.createMap();
    ...
    public static WritableMap convertCodeVerificationToWritableMap(
            @Nullable Source.CodeVerification codeVerification) {
        WritableMap map = Arguments.createMap();
